...
; Must be SPRITEMOVEDATA_FOLLOWEROBJ: `step_end` ends every applymovement by calling
; RestoreDefaultMovement, which reads the movement type back out of the map object. With
; FOLLOWNOTEXACT here the follower silently lost its ledge-hop/slide state machine after any
; scripted movement, until the next map load ran RefreshFollowingCoords.
