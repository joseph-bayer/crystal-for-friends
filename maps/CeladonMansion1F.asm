...
CeladonMansion1F_MapEvents:
	...
	object_event  2,  6, SPRITE_OW_MON_1, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonMansion1FMeowth, -1
	object_event  3,  4, SPRITE_CLEFAIRY, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonMansion1FClefairy, -1
	object_event  4,  4, SPRITE_OW_MON_2, SPRITEMOVEDATA_POKEMON, 2, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonMansion1FNidoranF, -1
