	...
	const LAKEOFRAGE_WILD_MON_1
	const LAKEOFRAGE_WILD_MON_2
	const LAKEOFRAGE_WILD_MON_3
...
; The Red Gyarados keeps its vanilla sprite and bobbing: the Gyarados icon in the NPC red, not a
; wandering-mon slot. The battle is shiny through BATTLETYPE_FORCESHINY.
	object_event 18, 22, SPRITE_GYARADOS, SPRITEMOVEDATA_WANDER, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RedGyarados, EVENT_LAKE_OF_RAGE_RED_GYARADOS
...
; here is decided by whether its slot holds a rolled mon, not by a flag.
	object_event 15, 25, SPRITE_OW_MON_1, SPRITEMOVEDATA_SWIM_WANDER_NOCLIP, 2, 2, -1, -1, 0, OBJECTTYPE_WILDMON, 0, ObjectEvent, -1
	object_event 34,  8, SPRITE_OW_MON_2, SPRITEMOVEDATA_SWIM_WANDER_NOCLIP, 2, 2, -1, -1, 0, OBJECTTYPE_WILDMON, 0, ObjectEvent, -1
	object_event 31, 17, SPRITE_OW_MON_3, SPRITEMOVEDATA_SWIM_WANDER_NOCLIP, 2, 2, -1, -1, 0, OBJECTTYPE_WILDMON, 0, ObjectEvent, -1
