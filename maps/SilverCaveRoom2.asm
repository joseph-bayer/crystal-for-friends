	...
	const SILVERCAVEROOM2_WILD_MON_1
	const SILVERCAVEROOM2_WILD_MON_2
	const SILVERCAVEROOM2_WILD_MON_3
	const SILVERCAVEROOM2_WILD_MON_4
...
; holds a rolled mon, not by a flag.
	object_event 20,  4, SPRITE_OW_MON_1, SPRITEMOVEDATA_WANDER_NOCLIP, 2, 2, -1, -1, 0, OBJECTTYPE_WILDMON, 0, ObjectEvent, -1
	object_event 21, 29, SPRITE_OW_MON_2, SPRITEMOVEDATA_WANDER_NOCLIP, 2, 2, -1, -1, 0, OBJECTTYPE_WILDMON, 0, ObjectEvent, -1
	object_event 17, 14, SPRITE_OW_MON_3, SPRITEMOVEDATA_SWIM_WANDER_NOCLIP, 2, 2, -1, -1, 0, OBJECTTYPE_WILDMON, 0, ObjectEvent, -1
