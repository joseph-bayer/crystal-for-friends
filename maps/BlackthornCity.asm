...
BlackthornKimScript:
  ...
  waitbutton
  closetext
  domysterygift NPC_MYSTERY_GIFT_NPC_KIM
  opentext
  writetext BlackthornCityKim_ExitText
  waitbutton
  closetext
  end
...
BlackthornCityKim_OfferMysteryGiftText:
...
BlackthornCityKim_ExitText:
  text "I won't stop until"
  line "I have them all!"

  para "Pretty-please come"
  line "back again"
  cont "tomorrow!"
  done
...
BlackthornCity_MapEvents:
	...
	object_event  9, 25, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, BlackthornKimScript, -1
	...
	object_event 35, 19, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BlackthornCooltrainerF2Script, -1
