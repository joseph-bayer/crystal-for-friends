...
ViridianNicknameSpeechHouse_MapEvents:
	...
	object_event  5,  2, SPRITE_OW_MON_1, SPRITEMOVEDATA_POKEMON, 2, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Speary, -1
	object_event  6,  3, SPRITE_OW_MON_2, SPRITEMOVEDATA_POKEMON, 2, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Rattey, -1
