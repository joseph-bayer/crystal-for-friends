...
MapGroup_Dungeons:
	...
	map ApricornForest, TILESET_FOREST, CAVE, LANDMARK_APRICORN_FOREST, MUSIC_SHOW_ME_AROUND, FALSE, PALETTE_NITE, FISHGROUP_POND
	map ApricornForestClearing, TILESET_FOREST, CAVE, LANDMARK_APRICORN_CLEARING, MUSIC_POKEMON_LULLABY, FALSE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_MysteryIslands:
	table_width MAP_LENGTH
; LANDMARK_SPECIAL on purpose: the arrival banner must not name the island before you can see it.
	map HiddenGrove, TILESET_ISLANDS, ROUTE, LANDMARK_SPECIAL, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ApricornForestOutside, TILESET_ISLANDS, ROUTE, LANDMARK_SPECIAL, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MysteryIsland3, TILESET_ISLANDS, ROUTE, LANDMARK_SPECIAL, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	assert_table_length NUM_MYSTERY_ISLANDS_MAPS
