...
ExecutiveMGroup:
	...
	db 38
	dw CHARIZARD
	db CHARIZARD_ROCKET_FORM
	dw FLAMETHROWER, WING_ATTACK, SLASH, NO_MOVE
	db 40
	dw SLOWBRO
	db PLAIN_FORM
	...
	db 39
	dw CHARMELEON
	db CHARMELEON_ROCKET_FORM
	dw SMOG, FLAMETHROWER, SLASH, NO_MOVE
	db 38
	dw CLOYSTER
	db PLAIN_FORM
