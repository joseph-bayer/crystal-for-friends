...
MovesGen1:
	...
	move EFFECT_MULTI_HIT,          20, NORMAL,        100, 35,   0      ;DOUBLESLAP
	move EFFECT_MULTI_HIT,          25, NORMAL,        100, 25,   0      ;COMET_PUNCH
	move EFFECT_NORMAL_HIT,         80, NORMAL,         85, 20,   0      ;MEGA_PUNCH
	move EFFECT_PAY_DAY,            60, NORMAL,        100, 20,   0      ;PAY_DAY
	...
	move EFFECT_RAZOR_WIND,         80, NORMAL,         95, 15,   0      ;RAZOR_WIND
	...
	move EFFECT_FLY,                70, FLYING,        100, 15,   0      ;FLY
	move EFFECT_TRAP_TARGET,        15, NORMAL,         85, 20,   0      ;BIND
	move EFFECT_NORMAL_HIT,         80, NORMAL,        100, 20,   0      ;SLAM
	...
	move EFFECT_FLINCH_HIT,         60, FIGHTING,      100, 15,  30      ;ROLLING_KICK
	...
	move EFFECT_MULTI_HIT,          18, NORMAL,        100, 20,   0      ;FURY_ATTACK
	...
	move EFFECT_RECOIL_HIT,         95, NORMAL,        100, 20,   0      ;TAKE_DOWN
	...
	move EFFECT_MULTI_HIT,          20, BUG,           100, 30,   0      ;PIN_MISSILE
	...
	move EFFECT_DISABLE,             0, NORMAL,         75, 20,   0      ;DISABLE
	...
	move EFFECT_FREEZE_HIT,        120, ICE,            85,  5,  10      ;BLIZZARD
	...
	move EFFECT_LEECH_HIT,          40, GRASS,         100, 20,   0      ;MEGA_DRAIN
	...
	move EFFECT_STATIC_DAMAGE,      40, DRAGON,        100, 20,   0      ;DRAGON_RAGE
	move EFFECT_TRAP_TARGET,        35, FIRE,          100, 15,   0      ;FIRE_SPIN
	...
	move EFFECT_HEAL,                0, NORMAL,        100,  5,   0      ;RECOVER
	...
	move EFFECT_NORMAL_HIT,        100, GRASS,         100, 10,   0      ;EGG_BOMB
	move EFFECT_PARALYZE_HIT,       30, GHOST,         100, 30,  30      ;LICK
	move EFFECT_POISON_HIT,         25, POISON,        100, 20,  40      ;SMOG
	...
	move EFFECT_FLINCH_HIT,         70, WATER,         100, 15,  30      ;WATERFALL
	...
	move EFFECT_MULTI_HIT,          20, NORMAL,        100, 20,   0      ;FURY_SWIPES
	move EFFECT_DOUBLE_HIT,         50, GROUND,         90, 20,   0      ;BONEMERANG
	move EFFECT_HEAL,                0, PSYCHIC_TYPE,  100,  5,   0      ;REST
	move EFFECT_FLINCH_HIT,         80, ROCK,           95, 15,  30      ;ROCK_SLIDE
	...
	move EFFECT_TRI_ATTACK,         85, NORMAL,        100, 15,  20      ;TRI_ATTACK
...
MovesGen2:
	...
	move EFFECT_TRIPLE_KICK,        20, FIGHTING,      100, 15,   0      ;TRIPLE_KICK
	move EFFECT_THIEF,              60, DARK,          100, 15, 100      ;THIEF
	...
	move EFFECT_FLAME_WHEEL,        65, FIRE,          100, 25,  10      ;FLAME_WHEEL
	...
	move EFFECT_NORMAL_HIT,        100, FLYING,         95, 10,   0      ;AEROBLAST
	...
	move EFFECT_POISON_HIT,         90, POISON,        100, 15,  30      ;SLUDGE_BOMB
	move EFFECT_ACCURACY_DOWN_HIT,  20, GROUND,        100, 15, 100      ;MUD_SLAP
	move EFFECT_ACCURACY_DOWN_HIT,  65, WATER,         100, 15,  50      ;OCTAZOOKA
	...
	move EFFECT_SPEED_DOWN_HIT,     65, ICE,           100, 20, 100      ;ICY_WIND
	move EFFECT_PROTECT,             0, FIGHTING,      100,  5,   0      ;DETECT
	move EFFECT_MULTI_HIT,          25, GROUND,        100, 20,   0      ;BONE_RUSH
	move EFFECT_LOCK_ON,             0, NORMAL,        100,  5,   0      ;LOCK_ON
	move EFFECT_RAMPAGE,           110, DRAGON,        100, 15,   0      ;OUTRAGE
	...
	move EFFECT_HEAL,                0, NORMAL,        100,  5,   0      ;MILK_DRINK
	...
	move EFFECT_SACRED_FIRE,       100, FIRE,           95, 10,  50      ;SACRED_FIRE
	move EFFECT_MAGNITUDE,           1, GROUND,        100, 30,   0      ;MAGNITUDE
	move EFFECT_CONFUSE_HIT,       100, FIGHTING,       50, 10, 100      ;DYNAMICPUNCH
	move EFFECT_NORMAL_HIT,        120, BUG,            85,  5,   0      ;MEGAHORN
	...
	move EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,          90, 15,  20      ;IRON_TAIL
	move EFFECT_ATTACK_UP_HIT,      70, STEEL,         100, 25,  10      ;METAL_CLAW
	...
	move EFFECT_SUNNY_DAY,           0, FIRE,           90, 10,   0      ;SUNNY_DAY
