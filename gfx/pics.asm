...
PikachuRBFrontpic:   		INCBIN "gfx/pokemon/pikachu_rb/front.animated.2bpp.lz"
PikachuRBBackpic:    		INCBIN "gfx/pokemon/pikachu_rb/back.2bpp.lz"
GolbatRocketFrontpic:		INCBIN "gfx/pokemon/golbat_rocket/front.animated.2bpp.lz"
GolbatRocketBackpic: 		INCBIN "gfx/pokemon/golbat_rocket/back.2bpp.lz"
ArbokRocketFrontpic: 		INCBIN "gfx/pokemon/arbok_rocket/front.animated.2bpp.lz"
ArbokRocketBackpic:  		INCBIN "gfx/pokemon/arbok_rocket/back.2bpp.lz"
SnorlaxApricornFrontpic:	INCBIN "gfx/pokemon/snorlax_apricorn/front.animated.2bpp.lz"
CharmeleonRocketFrontpic:	INCBIN "gfx/pokemon/charmeleon_rocket/front.animated.2bpp.lz"
