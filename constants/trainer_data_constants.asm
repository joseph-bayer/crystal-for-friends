...
; TrainerTypes bits (see engine/battle/read_trainer_party.asm)
	...
	const TRAINERTYPE_FORM_F  ; 2

; Trainer party types (see data/trainers/parties.asm)
DEF TRAINERTYPE_NORMAL     EQU 0					; 00000000
DEF TRAINERTYPE_MOVES      EQU 1 << TRAINERTYPE_MOVES_F 		; 00000001
DEF TRAINERTYPE_ITEM       EQU 1 << TRAINERTYPE_ITEM_F 			; 00000010
DEF TRAINERTYPE_FORM       EQU 1 << TRAINERTYPE_FORM_F 			; 00000100
