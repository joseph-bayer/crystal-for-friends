...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_APRICORN_FOREST_CLEARING_RED ; 1f
	const FRUITTREE_APRICORN_FOREST_CLEARING_BLU ; 20
	const FRUITTREE_APRICORN_FOREST_CLEARING_BLK ; 21
	const FRUITTREE_APRICORN_FOREST_CLEARING_WHT ; 22
	const FRUITTREE_APRICORN_FOREST_CLEARING_PNK ; 23
	const FRUITTREE_APRICORN_FOREST_CLEARING_GRN ; 24
	const FRUITTREE_APRICORN_FOREST_CLEARING_YLW ; 25
	const FRUITTREE_APRICORN_FOREST_RED ; 26
	const FRUITTREE_APRICORN_FOREST_BLU ; 27
	const FRUITTREE_APRICORN_FOREST_BLK ; 28
	const FRUITTREE_APRICORN_FOREST_WHT ; 29
	const FRUITTREE_APRICORN_FOREST_PNK ; 2a
	const FRUITTREE_APRICORN_FOREST_GRN ; 2b
	const FRUITTREE_APRICORN_FOREST_YLW ; 2c
